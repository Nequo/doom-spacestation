...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Lilex" :size 15 :weight 'regular)
      doom-variable-pitch-font (font-spec :family "Aporetic Sans" :size 13))
;;
...
(after! (org doom-themes)
  (setq org-priority-faces
        `((?A . (:foreground ,(doom-color 'red) :weight bold))
          ...
          (?C . (:foreground ,(doom-color 'yellow))))))
